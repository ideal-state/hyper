...
public class CommandResult<T> {
    ...
    public CommandResult(@NotNull Code code) {
        this(code, -1, null);
    }

    private CommandResult(@NotNull Code code, int acceptedDepth, T data) {
    ...
    public boolean equals(Object o) {
        ...
        @SuppressWarnings("rawtypes") final CommandResult that = (CommandResult) o;
