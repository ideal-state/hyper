...
package team.idealstate.hyper.director.api.unit;
...
public interface CommandCompleter {
    ...
    CommandCompleter DEFAULT = (context, exampleList, arguments, depth, argument, incomplete) -> {
    ...
    @NotNull
    List<String> complete(@NotNull CommandContext context, @NotNull List<String> exampleList,
